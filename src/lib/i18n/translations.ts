...
export const translations = {
  es: {
    nav: {
      ...
      marquee: [
        "Envío {b}gratis{/b} en Lima desde S/100",
    ...
    catalog: {
      ...
      from: "Desde",
      pageTitle: "Catálogo",
      pageSubtitle: "Productos para la aventura, con stock por variante y envío gratis en Lima desde S/100.",
    },
    comoFunciona: {
    ...
    trust: {
      items: [
        {
          titulo: "Envío gratis en Lima",
          texto: "Desde S/100 en compras dentro de Lima. Para provincia, el costo se calcula según destino.",
        },
    ...
    checkout: {
      ...
      freeShippingMissingSuffix: " para envío gratis en Lima 🚚",
  ...
  en: {
    nav: {
      ...
      marquee: [
        "{b}Free shipping{/b} in Lima from S/100",
    ...
    catalog: {
      ...
      from: "From",
      pageTitle: "Catalog",
      pageSubtitle: "Gear for adventure, with real stock per variant and free shipping in Lima from S/100.",
    },
    comoFunciona: {
    ...
    trust: {
      items: [
        {
          titulo: "Free shipping in Lima",
          texto: "From S/100 on orders within Lima. For other regions, cost is calculated by destination.",
        },
    ...
    checkout: {
      ...
      freeShippingMissingSuffix: " more for free shipping in Lima 🚚",
