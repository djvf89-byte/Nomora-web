...
export const translations = {
  es: {
    ...
    checkout: {
      ...
      payWithCardOrTicket: "Tarjeta / Pago Efectivo",
      payWithYape: "Yape",
      payWithYapeSubtitle: "Paga con el código de tu app Yape",
      yapePhone: "Número de celular (Yape)",
      yapeOtp: "Código de 6 dígitos",
      yapeOtpHelp: "Abre tu app Yape y genera el código para aprobar el cobro.",
      yapePay: "Pagar con Yape",
      paymentRejected: "No se pudo procesar el pago. Verifica los datos e intenta de nuevo.",
    },
    confirm: {
  ...
  en: {
    ...
    checkout: {
      ...
      payWithCardOrTicket: "Card / Cash payment",
      payWithYape: "Yape",
      payWithYapeSubtitle: "Pay with the code from your Yape app",
      yapePhone: "Phone number (Yape)",
      yapeOtp: "6-digit code",
      yapeOtpHelp: "Open your Yape app and generate the code to approve the charge.",
      yapePay: "Pay with Yape",
      paymentRejected: "We couldn't process the payment. Check the details and try again.",
    },
    confirm: {
