      ...
      <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 sm:gap-16">
        ...
        <div>
          <div className="mb-3 flex flex-wrap gap-2">
            {texto.etiquetaOferta && (
              <span className="inline-flex w-fit items-center rounded-full bg-accent px-3 py-1 text-[11px] font-semibold tracking-[0.04em] text-accent-foreground uppercase">
                {texto.etiquetaOferta}
              </span>
            )}
            {texto.notaEspecial && (
              <span className="inline-flex w-fit items-center rounded-full bg-[var(--nomora-terracota)] px-3 py-1 text-[11px] font-semibold tracking-[0.04em] text-[var(--nomora-blanco-hueso)] uppercase">
                {texto.notaEspecial}
              </span>
            )}
          </div>
